				...
				<div class="single-page-header-inner">
					<div class="left-side">
						...
						<div class="header-details">
							<h3>David Peterson <span>Chuyên gia iOS + Nhà phát triển Node</span></h3>
							<ul>
	...
	<div class="row">
		...
		<div class="col-xl-8 col-lg-8 content-right-offset">
			...
			<div class="single-page-section">
				...
				<p>Sử dụng các khuôn khổ linh hoạt để cung cấp cái nhìn tổng quát vững chắc cho các chiến lược cấp cao. Các phương pháp lặp lại trong chiến lược doanh nghiệp thúc đẩy tư duy hợp tác để nâng cao giá trị tổng thể. Tăng cường tầm nhìn tổng thể về sự đổi mới phá cách thông qua đa dạng tại nơi làm việc và trao quyền.</p>

				<p>Tận dụng những cơ hội dễ dàng để xác định hoạt động có giá trị bổ sung để thử nghiệm. Vượt qua khoảng cách kỹ thuật số với các nhấp chuột bổ sung từ DevOps. Sự ngâm mình trong công nghệ nano dọc theo thông tin đường cao tốc sẽ khép lại vòng tròn tập trung hoàn toàn vào lợi nhuận.</p>
			</div>

			<!-- Danh sách đóng gói -->
			<div class="boxed-list margin-bottom-60">
				<div class="boxed-list-headline">
					<h3><i class="icon-material-outline-thumb-up"></i> Lịch sử công việc và phản hồi</h3>
				</div>
				<ul class="boxed-list-ul">
					<li>
						<div class="boxed-list-item">
							...
							<div class="item-content">
								<h4>Nhà phát triển Web, Cơ sở dữ liệu và API <span>Được đánh giá là Freelancer</span></h4>
					...
					<li>
						<div class="boxed-list-item">
							<!-- Nội dung -->
							<div class="item-content">
								<h4>Cài đặt giao diện WordPress <span>Được đánh giá là Freelancer</span></h4>
								<div class="item-details margin-top-10">
									<div class="star-rating" data-rating="5.0"></div>
									<div class="detail-item"><i class="icon-material-outline-date-range"></i> Tháng 6 năm 2019</div>
								</div>
							</div>
						</div>
					</li>
					<li>
						<div class="boxed-list-item">
							<!-- Nội dung -->
							<div class="item-content">
								<h4>Sửa mã Python Selenium <span>Được đánh giá là Nhà tuyển dụng</span></h4>
								<div class="item-details margin-top-10">
									<div class="star-rating" data-rating="5.0"></div>
									<div class="detail-item"><i class="icon-material-outline-date-range"></i> Tháng 5 năm 2019</div>
								</div>
								<div class="item-description">
									<p>Tôi rất ấn tượng với chất lượng công việc và tốc độ hoàn thành. Anh ấy còn đề nghị giúp đỡ với một phần khác của dự án mà chúng tôi không nghĩ đến ban đầu.</p>
								</div>
							</div>
						</div>
					</li>
					<li>
						<div class="boxed-list-item">
							<!-- Nội dung -->
							<div class="item-content">
								<h4>Sửa lỗi trang web PHP Core <span>Được đánh giá là Freelancer</span></h4>
								<div class="item-details margin-top-10">
									<div class="star-rating" data-rating="5.0"></div>
									<div class="detail-item"><i class="icon-material-outline-date-range"></i> Tháng 5 năm 2019</div>
								</div>
								<div class="item-description">
									<p>Công việc tuyệt vời, chắc chắn sẽ thuê lại. Dự án được hoàn thành không chỉ với yêu cầu mà còn đúng hạn, trong ngân sách nhỏ của chúng tôi.</p>
								</div>
							</div>
						</div>
					</li>
		...
		<div class="col-xl-4 col-lg-4">
			<div class="sidebar-container">
				...
				<div class="profile-overview">
					<div class="overview-item"><strong>Chỉ số đánh giá</strong><div class="star-rating" data-rating="4.8"></div></div>
					<div class="overview-item"><strong>Vị trí</strong> Đức</div>
