...
<html lang="en"> 
                    ...
                    <div class="resume-wrapper-inner mx-auto text-start bg-white shadow-lg">
                        <header style="background-color: #102C57; padding: 20px; border-radius: 15px; margin: 10px 20px;">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="title" name="title" placeholder="Vị trí ứng tuyển" style="width: 100%; padding: 8px; border-radius: 4px; border: 1px solid #ccc;">
    ...
    <div class="resume-section-content">
        <textarea cols="30" rows="5" placeholder="Nhập mô tả" name="summary" class="with-border" style="color: #000; font-size: 19px; line-height: 1.8; text-align: justify; margin: 0; background-color: #E8F5FA; padding: 10px; border-radius: 5px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);"></textarea>
    </div>
</section>
            ...
            <article class="resume-timeline-item position-relative pb-5">
                <div class="resume-timeline-item-header mb-2">
                    <select style="width: 100%; padding: 8px; border-radius: 4px; border: 1px solid #ccc;" name="companyId[]">
                        ...
                        <c:forEach items="${CVDAO.getAllCompanyNames()}" var="o">
            ...
            <article class="resume-timeline-item position-relative pb-5">
                <div class="resume-timeline-item-header mb-2">
                    <select style="width: 100%; padding: 8px; border-radius: 4px; border: 1px solid #ccc;" name="certificationId[]">
                        ...
                        <c:forEach items="${CVDAO.getAllCertificationNames()}" var="o">
            ...
            <article class="resume-timeline-item position-relative pb-5">
                <div class="resume-timeline-item-header mb-2">
                    <select style="width: 100%; padding: 8px; border-radius: 4px; border: 1px solid #ccc;" name="skillId[]">
                        ...
                        <c:forEach items="${CVDAO.getAllSkillNames()}" var="o">
                            <option value="${CVDAO.getSkillIdByName(o)}">${o}</option>
                        </c:forEach>
                    </select>
            ...
            <article class="resume-timeline-item position-relative pb-5">
                <div class="resume-timeline-item-header mb-2">
                    <select style="width: 100%; padding: 8px; border-radius: 4px; border: 1px solid #ccc;" name="schoolId[]">
                        ...
                        <c:forEach items="${CVDAO.getAllSchoolNames()}" var="o">
                    ...
                    <input type="date" name="educationStartDate[]" style="width: 49%; display: inline-block; margin-right: -4px; padding: 8px; border-radius: 4px; border: 1px solid #ccc;">
                    <input type="date" name="educationEndDate[]" style="width: 49%; display: inline-block; padding: 8px; border-radius: 4px; border: 1px solid #ccc;">
