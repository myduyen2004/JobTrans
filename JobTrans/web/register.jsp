...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
    ...
    <!-- Mirrored from www.vasterad.com/themes/hireo_21/pages-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Sep 2024 08:35:14 GMT -->
    <head>
                                ...
                                <ul id="responsive">
                                    ...
                                    <li><a href="#">For Employers</a>
                                        <ul class="dropdown-nav">
                                            ...
                                            <li><a href="single-freelancer-profile.html">Hồ sơ người tìm việc</a></li>
                                    ...
                                    <div class="header-notifications-dropdown">
                                        ...
                                        <div class="user-status">
                                            ...
                                            <div class="user-details">
                                                ...
                                                <div class="user-name">
                                                    Tom Smith <span>Người tìm việc</span>
                                                </div>
                                            </div>

                                            <!-- User Status Switcher -->
                                            <div class="status-switch" id="snackbar-user-status">
                                                <label class="user-online current-status">Đang hoạt động</label>
                                        ...
                                        <ul class="user-menu-small-nav">
                                            <li><a href="dashboard.html"><i class="icon-material-outline-dashboard"></i> Thống kê</a></li>
                    ...
                    <div class="col-xl-5 offset-xl-3">
                        ...
                        <div class="login-register-page">
                            ...
                            <div class="welcome-text">
                                <h3 style="font-size: 26px;">Hãy tạo tài khoản ngay bây giờ !</h3>
                                <span>Bạn đã có tài khoản ? <a href="pages-login.html">Đăng nhập !</a></span>
                            </div>
