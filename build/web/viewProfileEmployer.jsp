	...
	<div class="dashboard-content-container" data-simplebar>
		<div class="dashboard-content-inner" >
			...
			<div class="row">
                                        ...
                                        <ul class="fields-ul">
                                            <li>
                                                <div class="row">
                                                    <div class="col-xl-4">
                                                        <div class="submit-field">
                                                            <div class="bidding-widget">
                                                                <!-- Headline -->
                                                                <span class="bidding-detail">Quantity of <strong>Job</strong></span>
                                                    ...
                                                    <div class="col-xl-4">
                                                        <div class="submit-field">
                                                            <h5>Balance <i class="help-icon" data-tippy-placement="right" title="Add up to 10 skills"></i></h5>
                            ...
                            <!-- Button -->
                            <div class="col-xl-6">
                                <a href="changePassword.jsp" class="button ripple-effect big margin-top-30">Change Password</a>
                            </div>
                            
                            <div class="col-xl-6">
                                <a href="#" class="button ripple-effect big margin-top-30">Edit Profile</a>
                            </div>
