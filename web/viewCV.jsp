                            ...
                            <div class="col-xl-12">
                                <div class="dashboard-box margin-top-0">
                                    ...
                                    <div class="headline d-flex justify-content-between align-items-center">
                                        ...
                                        <!-- Thêm nút "Tạo CV" đặt cùng dòng -->
                                        <a href="CV?action=load-creating" class="button ripple-effect big">Tạo CV</a>
                                    </div>
                                    <div class="content">
                                                                ...
                                                                <div class="job-listing-description">
                                                                    <c:forEach items="${listcv}" var="o">
                                                                        <div class="headline">
                                                                            ...
                                                                            <div>
                                                                                <a href="CV?action=view&cvId=${o.cvId}" class="button ripple-effect big margin-top-30">Xem CV</a>

                                                                                <a href="CV?action=delete&cvId=${o.cvId}" class="button ripple-effect big margin-top-30">Xoá CV</a>

                                                                                <a href="CV?action=load-editing&cvId=${o.cvId}" class="button ripple-effect big margin-top-30">Sửa CV</a>
                                                                            </div>              
                                                                        </div>
                                                                    </c:forEach> 
