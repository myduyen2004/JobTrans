...
public class ForgotPassword extends HttpServlet {
    ...
    private void sendVerificationMail(String userName,  String subject, String email, String code) {
        ...
        try {
            new Gmail(email)
                    ...
                    .sendTemplate(new URL("http://localhost:8080/JobTrans/mail-noti/forgot-password.jsp"));
    ...
    throws ServletException, IOException {
        ...
        if (cmd.equals("1")) {
            ...
            try {
                if (receiveEmail != null && userDAO.checkExistEmail(receiveEmail)) {
                    ...
                    new Thread(() -> {
                        sendVerificationMail(user.getUserName(), "Mã xác minh khôi phục mật khẩu", receiveEmail, otpvalue);
                    }).start();
