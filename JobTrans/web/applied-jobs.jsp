					...
					<div class="dashboard-box margin-top-0">
						...
						<div class="content">
							<ul class="dashboard-box-list">
                                                            <c:forEach var="myJobGreeting" items="${jgList}">
                                                                <li>
									<!-- Job Listing -->
									<div class="job-listing width-adjustment">
										...
										<div class="job-listing-details">
											...
											<div class="job-listing-description">
												<h3 class="job-listing-title"><a href="home?action=jobDetail&jobId=${jobDAO.getJobByJobId(myJobGreeting.jobId).jobId}">${jobDAO.getJobByJobId(myJobGreeting.jobId).jobTitle}</a> <span class="dashboard-status-button yellow">${myJobGreeting.status}</span> </h3>
												...
												<div class="job-listing-footer">
													<ul>
														<li><i class="icon-material-outline-access-time"></i>Ngày hết hạn: ${jobDAO.getJobByJobId(myJobGreeting.jobId).dueDate}</li>
                                                                                                                <c:if test="${jobDAO.getJobByJobId(myJobGreeting.jobId).labelVerify} == 'Được duyệt'}">
									...
									<ul class="dashboard-task-info">
                                                                            <li><strong><fmt:formatNumber value="${myJobGreeting.price}" type="currency" pattern="#,##0" currencySymbol="₫" groupingUsed="true" /></strong><span>Giá Đã Đề Nghị</span></li>
									</ul>
                                                                        <div class="buttons-to-right always-visible">
										<a href="home?action=jobDetail&jobId=${jobDAO.getJobByJobId(myJobGreeting.jobId).jobId}" class="button ripple-effect">Xem công việc</a>
									</div>
								</li>
                                                            </c:forEach>
							</ul>
