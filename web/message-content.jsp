                ...
                <div style="margin-bottom: 10px;">
                    <div style="display: flex; align-items: center; justify-content: ${msg.senderId == senderId ? 'flex-end' : 'flex-start'};">
                        ...
                        <c:if test="${msg.senderId == senderId}">
                            ...
                            <img src="${userDAO.getUserById(senderId).avatarUrl}" alt="Sender Avatar" style="width: 40px; height: 40px; border-radius: 50%; margin-right: 10px;">
                        </c:if>

                        <!-- Tin nhắn nhận -->
                        <c:if test="${msg.senderId != senderId}">
                            <img src="${userDAO.getUserById(receiverId).avatarUrl}" alt="Receiver Avatar" style="width: 40px; height: 40px; border-radius: 50%; margin-left: 10px;">
