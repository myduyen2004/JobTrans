...
<html lang="en">
        ...
        <div id="wrapper">
            ...
            <div class="dashboard-container">
                ...
                <div class="dashboard-content-container" data-simplebar>
                    <form action="CreateCVServlet" method="post" enctype="multipart/form-data">
    ...
    <div style="margin-bottom: 10px;">
        ...
        <input type="text" id="nameCompany" name="nameCompany" value="name of company" style="width: 100%; padding: 8px; border-radius: 4px; border: 1px solid #ccc;">
    </div>
    
    <div style="margin-bottom: 10px;">
        <label for="description">Description:</label>
        <input type="text" id="description" name="description" value="" style="width: 100%; padding: 8px; border-radius: 4px; border: 1px solid #ccc;">
    </div>
    ...
    <div style="width: 100%;">
        <input type="text" name="Skill" value="Skill" style="width: 49%; display: inline-block; margin-right: -4px; padding: 8px; border-radius: 4px; border: 1px solid #ccc;">
        <input type="text" name="proficiency" value="proficiency" style="width: 49%; display: inline-block; padding: 8px; border-radius: 4px; border: 1px solid #ccc;">
    </div>
</div>
                    <div style="border: 1px solid #ccc; padding: 15px; margin-bottom: 20px; border-radius: 8px;">
    <h4>Skills & Tools</h4>
    <div style="margin-bottom: 10px;">
        <label for="nameCompany">School name:</label>
        <input type="text" id="schoolName" name="schoolName" value="schoolName" style="width: 100%; padding: 8px; border-radius: 4px; border: 1px solid #ccc;">
    </div>
    
    <div style="margin-bottom: 10px;">
        <label for="description">Field of study</label>
    ...
    <div style="margin-bottom: 10px;">
        ...
        <input type="text" id="degree" name="degree" value="" style="width: 100%; padding: 8px; border-radius: 4px; border: 1px solid #ccc;">
    </div>
                                ...
                                </ul> <a href="" class="button ripple-effect big margin-top-30">Lưu CV</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-12">
